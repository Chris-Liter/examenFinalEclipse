...
a persistence unit "FinalPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Final/pom.xml":
...
artifact ("Final.war") is already built. You can build
